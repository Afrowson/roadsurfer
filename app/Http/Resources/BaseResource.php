...
/**
 * This Class is copied from a private repository,
 * written by me, not used in any company I worked for.
 *
 * Adds the possibility to show/hide attributes in a resources
 * based on the presentation and single/collection mode.
 */
abstract class BaseResource extends JsonResource
{
    ...
    {
        dump($presentation);
        dd(in_array(static::$presentation[static::class] ?? null, Arr::wrap($presentation)));
